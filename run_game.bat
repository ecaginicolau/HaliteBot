...
rem halite.exe -s 2293387012 -d "312 206" "python MyBot.py" "..\HaliteBotV59\run_bot.bat"
rem halite.exe -s 3931559233 -d "312 206" "python MyBot.py" "..\HaliteBotV59\run_bot.bat"
rem halite.exe -s 3217122367 -d "312 206" "python MyBot.py" "..\HaliteBotV68\run_bot.bat"
rem halite.exe -d "312 206" "python MyBot.py" "..\HaliteBotV74\run_bot.bat"
rem halite.exe -s 1832720790 -d "240 160" "python MyBot.py" "..\HaliteHerve\run_bot.bat"
halite.exe -s 2146537035 -d "312 206" "python MyBot.py" "..\HaliteHerve\run_bot.bat"
rem halite.exe -s 2146537035 -d "312 206" "..\HaliteBotV74\run_bot.bat" "..\HaliteHerve\run_bot.bat"
